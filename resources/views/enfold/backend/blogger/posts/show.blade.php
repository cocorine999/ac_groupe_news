...
@section('title',' Détails de l\'article : '.ucfirst($post->title))
@push('css')
...
<div class="container-fluid">
    ...
    <div class="body">
        <div class="form-group">
            <a href="{{ route('blogger.posts.index') }}" class="btn btn-danger waves-effet"> <i class="material-icons">keyboard_backspace</i> <span> RETOUR </span></a>
            ...
            <a class="btn btn-blue  waves-effet pull-right disabled"> <i class="material-icons">done</i> <span> Autoriser </span></a>
            @else
            <a href="{{route('blogger.posts.authorized',$post->id)}}" type="button" class="btn btn-blue pull-right waves-effect "><span> Autorisation </span> <i class="material-icons">done</i></a>
            @endif
            @endif
        </div>
                ...
                <div class="card">
                    <div class="header">
                        <h2>
                            ...
                            <small>Posted by <strong> <a href=""> {{$post->author->name}} </a> </strong> on {{$post->created_at->toFormattedDateString()}} </small>
                        </h2>
