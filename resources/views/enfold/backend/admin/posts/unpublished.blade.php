...
@section('title','Liste des articles en attentes de validation')
@push('css')
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.posts.published',$post->id)}}" type="button" class="btn bg-blue waves-effect "><i class="material-icons">send</i></a>
