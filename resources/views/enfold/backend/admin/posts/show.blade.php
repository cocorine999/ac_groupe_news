...
<div class="container-fluid">
    ...
    <div class="body">
        <div class="form-group">
            <a href="{{ route('admin.posts.index') }}" class="btn btn-danger waves-effet"> <i class="material-icons">keyboard_backspace</i> <span> RETOUR </span></a>
            ...
            @else
            <a href="{{route('admin.posts.authorized',$post->id)}}" type="button" class="btn bg-red pull-right waves-effect "><span> Autorisation </span> <i class="material-icons"></i></a>
            @endif
            @endif
        </div>
