...
<div class="container-fluid">
    ...
    <div>
        <a class="btn btn-success waves-effect" href="{{ route('admin.posts.create') }}" role="button"><i class="material-icons primary">add</i><span>Nouveau</span> </a>
    </div>
                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.posts.show',$post->id)}}" class="btn btn-success waves-effect align-center">
                                            <i class="material-icons ">visibility</i>
                                        </a>
                                        <a href="{{route('admin.posts.edit',$post->id)}}" class="btn btn-info waves-effect align-center">
                                        ...
                                        <form id="delete-form-{{$post->id}}" style="display: none;" method="POST" action="{{ route('admin.posts.destroy',$post->id) }}">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    </td>
