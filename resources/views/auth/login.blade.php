...
<head>
    ...
    <link href="{{ asset('enfold/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('enfold/css/mdb.min.css') }}" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{ asset('enfold/js/mdb.js') }}" type="text/javascript"></script>
